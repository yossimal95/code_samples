...
interface DragAndDropProps {
    children: ReactNode;
    dragHandleElement?: RefObject<HTMLElement>;
    containerStyle?: React.CSSProperties;
}

const DragAndDrop: React.FC<DragAndDropProps> = ({ children, dragHandleElement, containerStyle }) => {
    const draggableRef = useRef<HTMLDivElement | null>(null);

    useEffect(() => {
        if (dragHandleElement && dragHandleElement.current) {
            dragHandleElement.current.onmousedown = (e) => {
                e.preventDefault();
                e.stopPropagation();
                handleMouseDown(e);
            };
